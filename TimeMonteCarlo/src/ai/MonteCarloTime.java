 ...
 * @author Rohan
 */
public class MonteCarloTime extends OthelloPlayer {
    Test test=new Test();
    ...
    { 
       long starttime=System.currentTimeMillis();
        return Search(state, Test.time, starttime);

    }
    public OthelloMove Search(OthelloState state, int maxtime, long starttime)
    {
